...
docker -H ssh://root@db-ultimate.frisbeeverband.at cp ulti-players_django_1:/workspace/backups ../..
docker -H ssh://root@db-ultimate.frisbeeverband.at exec -it ulti-players_django_1 sh -c 'rm backup/* -rf'
